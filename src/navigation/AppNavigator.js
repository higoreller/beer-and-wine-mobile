...
import RegisterDrinks from "../screens/RegisterDrinks";
...
const Main = () => {
  return (
    ...
    >
      ...
      <MainStack.Screen name="Cadastrar bebida" component={RegisterDrinks} />
      <MainStack.Screen name="Minhas bebidas" component={MyDrinks} />
    </MainStack.Navigator>
  );
};
